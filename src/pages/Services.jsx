...
const Services = () => {
  return (
    <div className="space-y-8">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-orange-500">Our Services</h1>
        <p className="mb-4 text-gray-300">At MiOrganics, we offer a comprehensive range of software development and IT services to help businesses thrive in the digital age. Our team of experts is committed to delivering high-quality solutions tailored to your unique needs.</p>
      </section>
      ...
      <section className="bg-orange-100 p-8 rounded-lg text-dark-800">
        ...
        <h3 className="text-xl font-semibold mb-2 text-orange-700">Key Features:</h3>
        ...
        <a href="https://www.xpmaps.com" target="_blank" rel="noopener noreferrer" className="text-orange-600 hover:underline">Learn more about XP Maps</a>
      </section>
    </div>
  );
};
